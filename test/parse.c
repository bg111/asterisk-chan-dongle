...
void test_parse_cmgr()
{
	...
	static const struct test_case {
		...
		{ "+CMGR: 0,,159\r\",
			{
				NULL,
				"",
				"+447919216118",
				STR_ENCODING_7BIT,
				"",
		...
		{ "+CMGR: 0,,80\r\n0791448720003023440C9144774072357400005170131141444045050003480202402ED0B50C4287ED65D0BC5C7683E8E832280C0FCBE9EDB29B0E7ABB41E77A9B2E2F97412E10F54D0EE741499039ED4ECFD1A0301D6403",
			{
				NULL,
				"050003480202402ED0B50C4287ED65D0BC5C7683E8E832280C0FCBE9EDB29B0E7ABB41E77A9B2E2F97412E10F54D0EE741499039ED4ECFD1A0301D6403",
				"+447704275347",
				STR_ENCODING_7BIT,
				"050003480202402ED0B50C4287ED65D0BC5C7683E8E832280C0FCBE9EDB29B0E7ABB41E77A9B2E2F97412E10F54D0EE741499039ED4ECFD1A0301D6403",
				STR_ENCODING_7BIT_HEX
		...
		{ "+CMGR: 0,,155\r\",
			{
				NULL,
				"",
				"4F597509",
				STR_ENCODING_7BIT_HEX,
				"",
				STR_ENCODING_7BIT_HEX
	...
	for(; idx < ITEMS_OF(cases); ++idx) {
		...
		memset(sms_utf8_str, 0, sizeof (sms_utf8_str));
		res = str_recode (RECODE_DECODE, result.msg_enc, result.msg, strlen(result.msg), sms_utf8_str, sizeof (sms_utf8_str));
		if (res < 0) {
			printf("\n{str_recode} error :(\n");
		} else {
			printf("\n{str_recode} %s\n", sms_utf8_str);
